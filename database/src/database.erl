...
install() ->
    ...
    create_table(db_djelatnik_kolegij,
                 ...
                 [#db_djelatnik_kolegij.id_djelatnik]),
    create_table(db_student_kolegij,
                 bag,
                 Nodes,
                 record_info(fields, db_student_kolegij),
                 [#db_student_kolegij.id_kolegij]),
    ...
    create_table(db_sekcija_sadrzaj,
                 bag,
                 Nodes,
                 record_info(fields, db_sekcija_sadrzaj),
                 [#db_sekcija_sadrzaj.id_sadrzaj]),
